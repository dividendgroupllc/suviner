...
from suviner.frappe_and_erpnext_based_app.doctype.kassa.kassa import Kassa, get_exchange_rate
...
class UnitTestKassa(FrappeTestCase):
    ...
    @patch("suviner.frappe_and_erpnext_based_app.doctype.kassa.kassa.frappe.get_cached_value")
    ...
    @patch("suviner.frappe_and_erpnext_based_app.doctype.kassa.kassa.get_exchange_rate", return_value=12200)
    ...
    @patch("suviner.frappe_and_erpnext_based_app.doctype.kassa.kassa.get_exchange_rate", return_value=0.000081967)
    ...
    @patch("suviner.frappe_and_erpnext_based_app.doctype.kassa.kassa.frappe.db.get_value")
    ...
    @patch("suviner.frappe_and_erpnext_based_app.doctype.kassa.kassa.frappe.msgprint")
    @patch("suviner.frappe_and_erpnext_based_app.doctype.kassa.kassa.frappe.utils.get_link_to_form", return_value="PAYMENT-LINK")
    @patch("suviner.frappe_and_erpnext_based_app.doctype.kassa.kassa.frappe.get_cached_value")
    @patch("suviner.frappe_and_erpnext_based_app.doctype.kassa.kassa.frappe.new_doc")
    ...
    @patch("suviner.frappe_and_erpnext_based_app.doctype.kassa.kassa.frappe.msgprint")
    @patch("suviner.frappe_and_erpnext_based_app.doctype.kassa.kassa.frappe.utils.get_link_to_form", return_value="JE-LINK")
    @patch("suviner.frappe_and_erpnext_based_app.doctype.kassa.kassa.get_exchange_rate", return_value=0.000081967)
    @patch("suviner.frappe_and_erpnext_based_app.doctype.kassa.kassa.frappe.get_cached_value")
    @patch("suviner.frappe_and_erpnext_based_app.doctype.kassa.kassa.frappe.new_doc")
